package org.example.myselectshop.aop;
...
import org.example.myselectshop.repository.ApiUseTimeRepository;
...
public class UseTimeAop {
    ...
    @Pointcut("execution(* org.example.myselectshop.controller.ProductController.*(..))")
    private void product() {}
    @Pointcut("execution(* org.example.myselectshop.controller.FolderController.*(..))")
    private void folder() {}
    @Pointcut("execution(* org.example.myselectshop.naver.controller.NaverApiController.*(..))")
    private void naver() {}
